...
public class Xnegative extends Graph implements Runnable {    
    ...
    public void run()
    {
        ...
        for(int i=width/2-20;i>=0;i=i-lsize)
        {
            ...
            if(n==0)
            {
                g3.drawString(String.valueOf(temp),lend+lsize,height/2+20);
            }
            else
                g3.drawString(String.valueOf(temp),i+lsize,height/2+20);
